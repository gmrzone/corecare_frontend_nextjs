...
const Services = (props) => {
    ...
    const service_category = router.query
    ...
    return (
        <>  
            {serviceListActive ? <ServiceList category={service_category} active={serviceListVisible} setActive={toggleServiceList} reference={ServiceListRef} searchParam={search_param}/> : ""}
            ...
            <BigServiceTab serviceCategory={renderTitle()} accordianItem={accordianItem} about={renderBigServiceBoxText()} category={service_category}/>
