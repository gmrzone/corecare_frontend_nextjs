...
// const RichToolbox = ({ onBoldClick , onItalicClick, onUnderLineClick, onBlockChange, toggleColor, setAlignItem }) => {
//     const BLOCK_TYPES = [
...
//             <HeadingDropDown options={headingOptions} defaultSelected={headingOptions[0]} width="100px" onBlockChange={onBlockChange} heading={true}/>
...
//             <HeadingDropDown options={alignIcons} defaultSelected={alignIcons[0]} width="50px" height="auto" onBlockChange={onBlockChange} setAlignItem={setAlignItem}/>
//             <div className={style.editor_block + " " + style.editor_inline}>
