...
const SignupModelContentWrapper = ({ closeSignup }) => {
    ...
    return (
        <>  
            ...
            {signup.otpSend && signup.otpVerified && signup.profilePicUpdated ? <SignUpThree signUpstate={signup} closeModel={closeSignUpModel} successPath="/login/signup" additionalTask={null}/>  : ""}
        </>
    )
}
